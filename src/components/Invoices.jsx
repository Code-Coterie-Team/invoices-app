...
<>
    <div className='flex h-full w-screen'>
      ...
      <div className='flex justify-between w-full'>
            ...
            <div className='flex gap-11 items-center'>
                ...
                <button className='flex gap-3 bg-button p-2 rounded-3xl items-center' onClick={()=>setShowModal(true)}>
  ...
  {showModal && <div className="w-screen h-full bg-black/40 fixed top-0 left-0" onClick={()=>setShowModal(false)}>
          <Sidebar/>
